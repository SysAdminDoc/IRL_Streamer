...
object SettingsCatalog {
    ...
    private val root = SettingsPageSpec(
        title = "Settings",
        items = listOf(
            SettingItem.Row("identity", "IRL Streamer", "Version 0.1.0 · clean-room reconstruction", accentTitle = true),
    ...
    private val streamer = SettingsPageSpec(
        ...
        items = listOf(
            ...
            SettingItem.Row("custom_chatbox_url", "Custom chatbox URL", "Setting this ignores the username settings above", action = SettingAction.Dialog(text("custom_chatbox_url", "Custom chatbox URL"))),
    ...
    private val bonding = SettingsPageSpec(
        ...
        items = listOf(
            ...
            SettingItem.Row("own_server", "1. Own Bonding Server", "Use an independently licensed, owner-controlled server implementation."),
    ...
    private val audio = SettingsPageSpec(
        ...
        items = listOf(
            ...
            SettingItem.Slider("audio_input_gain_db", "Input gain", "Double tap to reset to 0dB", -40f, 10f, 49, formatter = { value -> if (value > 0) "+%.1f".format(value) else "%.1fdB".format(value) }),
    ...
    private val recording = SettingsPageSpec(
        ...
        items = listOf(
            ...
            SettingItem.Toggle("split_sections", "Split video into sections", "Video recording is split into sections by default for reliability purposes."),
